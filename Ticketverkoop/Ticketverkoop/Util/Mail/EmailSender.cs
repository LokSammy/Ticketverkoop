...
namespace Ticketverkoop.Util.Mail
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        public async Task SendEmailAsync(string email, string subject, string message)
        {
            ...
            mail.From = new MailAddress("sammy.mvccore@gmail.com"); // eigen emailadres
            ...
            try
            {
                using (var smtp = new SmtpClient(_emailSettings.MailServer))
                {
                    ...
                    smtp.EnableSsl = true;
                    smtp.Credentials = new NetworkCredential(_emailSettings.SenderName, _emailSettings.Password);
